...
public interface ActiveMQInVmLogger extends BasicLogger {

   /**
    * The default logger.
    */
   ActiveMQInVmLogger LOGGER = Logger.getMessageLogger(ActiveMQInVmLogger.class, ActiveMQInVmLogger.class.getPackage().getName());
